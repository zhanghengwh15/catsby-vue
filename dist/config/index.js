...
;(function () {
  ...
  // api接口请求地址
  window.SITE_CONFIG['baseUrl'] = 'http://47.107.185.156:8078/fast';
  // cdn地址 = 域名 + 版本号
  window.SITE_CONFIG['domain']  = './'; // 域名
  window.SITE_CONFIG['version'] = '1901091036';   // 版本号(年月日时分)
...
;(function() {
  var resList = {
    ...
    js: [
      ...
      // 插件 - echarts
      window.SITE_CONFIG.cdnUrl + '/static/plugins/ace/src/ace.js',
